...
public:
	...
	void Dump();
	b2Vec2 GetForce();
	void SetForce(const b2Vec2 force_);
	void ApplyLinearImpulseCenter(const b2Vec2& impulse);
...
// Ìî¸ ========================================
inline b2Vec2 b2Body::GetForce(){
	return m_force;
}
inline void b2Body::SetForce(const b2Vec2 force_){
	m_force = force_;
}
// ===========================================
...
inline void b2Body::ApplyLinearImpulseCenter(const b2Vec2& impulse)
{
	if (m_type != b2_dynamicBody)
	{
		return;
